...
export const verifyTicket = async (req, res) => {
  try {
    ...
    // In a real app, we should verify that the scanner is authorized to scan for this event
    // For now, we assume any authorized planner/employee can scan
    ...
    const ticket = await Ticket.findById(ticketId).populate('ticketTypeId', 'title');
    ...
    const start = new Date(ticket.issuedAt);
    const now = new Date();
